...
fine::ResourcePtr<Tensor> reshape(
  ...
  return wrap(mx::reshape(a->array, to_mlx_shape(shape)));
}
FINE_NIF(reshape, 0);
...
fine::ResourcePtr<Tensor> transpose(
  ...
  return wrap(mx::transpose(a->array, to_int_vec(axes)));
}
...
fine::ResourcePtr<Tensor> squeeze(
    ...
    fine::ResourcePtr<Tensor> a,
    std::vector<int64_t> axes) {
  return wrap(mx::squeeze(a->array, to_int_vec(axes)));
}
FINE_NIF(squeeze, 0);
...
fine::ResourcePtr<Tensor> expand_dims(
    ...
    fine::ResourcePtr<Tensor> a,
    std::vector<int64_t> axes) {
  return wrap(mx::expand_dims(a->array, to_int_vec(axes)));
}
...
fine::ResourcePtr<Tensor> broadcast_to(
    ...
    fine::ResourcePtr<Tensor> a,
    std::vector<int64_t> shape) {
  return wrap(mx::broadcast_to(a->array, to_mlx_shape(shape)));
}
...
fine::ResourcePtr<Tensor> concatenate(
    ...
    int64_t axis) {
  return wrap(mx::concatenate(unwrap_all(arrays), static_cast<int>(axis)));
}
...
fine::ResourcePtr<Tensor> stack(
    ...
    std::vector<fine::ResourcePtr<Tensor>> arrays,
    int64_t axis) {
  return wrap(mx::stack(unwrap_all(arrays), static_cast<int>(axis)));
}
FINE_NIF(stack, 0);
...
fine::ResourcePtr<Tensor> flatten(
  ...
  return wrap(mx::flatten(
      a->array, static_cast<int>(start_axis), static_cast<int>(end_axis)));
}
FINE_NIF(flatten, 0);
...
fine::ResourcePtr<Tensor> tile(
  ...
  return wrap(mx::tile(a->array, to_int_vec(reps)));
}
FINE_NIF(tile, 0);
...
fine::ResourcePtr<Tensor> swapaxes(
  ...
  return wrap(mx::swapaxes(
      a->array, static_cast<int>(axis1), static_cast<int>(axis2)));
}
FINE_NIF(swapaxes, 0);
...
fine::ResourcePtr<Tensor> repeat(
  ...
  return wrap(mx::repeat(
      a->array, static_cast<int>(repeats), static_cast<int>(axis)));
}
FINE_NIF(repeat, 0);
